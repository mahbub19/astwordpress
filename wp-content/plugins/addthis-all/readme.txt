=== WordPress Website Tools Plugin – AddThis ===
...
Tags: website tools, share buttons, follow buttons, related posts, email list building, link promotion
...
By simply installing this plugin on your WordPress site, you have access to a suite of website tools designed to help engage your audience and drive new traffic. You can make edits to these website tools within the AddThis dashboard.

* Share Buttons: make your content shareable

* Follow Buttons: build your audience one fan at a time

* Related Posts: engage readers with your most popular content

* List Building: collect and build your email subscriber list

* Link Promotion: promote the right page at the right time

AddThis is used by over 15,000,000 websites with over 2 billion unique users, sharing content all over the world, in more than sixty languages.
...
= We also have individual plugins available for some of our most popular tools. Check them out! =
...
1. Go to <a href="https://wordpress.org/plugins/addthis-all">https://wordpress.org/plugins/addthis-all</a> and click on **Download** to download the AddThis zipped plugin files
...
1. Go to <a href=https://wordpress.org/plugins/addthis-all>https://wordpress.org/plugins/addthis-all</a> and click on **Download** to download the AddThis zipped plugin files (do not unzip this file)
