...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'kage' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'kage' ),
		'repeat-y'  => __( 'Repeat Vertically', 'kage' ),
		'repeat'    => __( 'Repeat All', 'kage' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'kage' ),
		'top center'    => __( 'Top Center', 'kage' ),
		'top right'     => __( 'Top Right', 'kage' ),
		'center left'   => __( 'Middle Left', 'kage' ),
		'center center' => __( 'Middle Center', 'kage' ),
		'center right'  => __( 'Middle Right', 'kage' ),
		'bottom left'   => __( 'Bottom Left', 'kage' ),
		'bottom center' => __( 'Bottom Center', 'kage' ),
		'bottom right'  => __( 'Bottom Right', 'kage')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'kage' ),
		'fixed'  => __( 'Fixed in Place', 'kage')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'kage' ),
		'italic'      => __( 'Italic', 'kage' ),
		'bold'        => __( 'Bold', 'kage' ),
		'bold italic' => __( 'Bold Italic', 'kage' )
		);
